...
class StepInfoTop {
            ...
            )
            {
                ...
                Box(
                    ...
                    Row(
                        ...
                        StepText(text = "Remaining", value = (target - totalSteps.toInt()).toString())
                        StepText(text = "Target", value = target.toString())
                    }
                }
            }
        }
    ...
    @Composable
    private fun StepText(text: String, value: String) {
        Column(
            modifier = Modifier.padding(10.dp)
        ) {
            Text(text = text, style = Typography.labelSmall)
            Text(text = value, style = Typography.labelLarge)
        }
    }
}